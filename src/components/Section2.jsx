      ...
      <div className="flex  justify-center items-center space-x-40 max-md:flex-col max-md:space-x-0 max-md:px-20 ">
        ...
        <div className="">
          <div className="py-6 ">
            ...
            <h1 className="text-4xl text-black font-bold tracking-widest w-5/12 max-md:text-xl
            max-md:w-full">
              Solutions designed for all your needs
            </h1>
            <p className="w-1/2 text-sm py-4 max-md:w-full max-sm:w-full max-md:text-[13px]">
          ...
          <div className="flex items-center space-x-20  max-md:text-nowrap max-sm:flex-col max-sm:space-x-0 max-sm:space-y-6">
            <button className="bg-orange-500 text-white px-8 py-2 rounded-xl text-xl  max-md:text-lg ">
              View Availability
            </button>
